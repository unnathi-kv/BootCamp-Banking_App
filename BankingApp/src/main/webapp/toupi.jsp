...
<div id="test-header" class="accordion_headings header_highlight">To UPI</div>
	<div id="test-content">
      ...
      <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nunc ligula nisl, egestas non, pharetra vel, scelerisque accumsan, lacus. Proin nibh. Aenean dapibus. Quisque facilisis, ligula ut blandit hendrerit, purus neque rhoncus ipsum, 
		...
		<label for="upi_id" class="label-title">Enter UPI Id*</label><br>
          <input type="text" name="upi_id" class="form-input" placeholder="Enter the UPI Id" required="required">
          </div>
        <div class="form-group">
